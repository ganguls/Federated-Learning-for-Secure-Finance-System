#!/usr/bin/env python3
"""
Working version of the dashboard app with fixed JSON serialization
"""
...
class FLDashboard:
    ...
    def run_attack_detection_demo(self, malicious_percentage=20, attack_type='label_flipping', epsilon=1.0):
        """Run attack detection demonstration - FIXED VERSION"""
        try:
            ...
            # Create client details - CONVERT ALL NUMPY TYPES IMMEDIATELY
            client_details = []
            ...
            # Create detection result - CONVERT ALL NUMPY TYPES IMMEDIATELY
            detection_result = {
            ...
            # Convert all remaining NumPy types
...
def run_detection_demo():
    """Run attack detection demo - FIXED VERSION"""
    try:
        ...
        # Ensure result is fully converted to Python native types
